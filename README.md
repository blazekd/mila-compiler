...
This is semestral work for [Programming Languages and Compilers course](https://bilakniha.cvut.cz/en/predmet1123106.html) at [FIT CTU](https://fit.cvut.cz/en).


The goal of this work was to create LL(1) grammar and then create compiler frontend (Lexer, Parser, Abstract syntax tree) for Pascal inspired programming language called mila. LLVM is used as compiler backend.

## Supported language constructs

* Main function, print numbers (print, println), read numbers (readln), global variables, expressions, assignment, decimal constants 
* Hexadecimal and octal constants (prefix $ a &)
...
All should be covered in `samples` folder. You can inspect final LL(1) grammar in `parser_grammar.txt`.



# Semestral Work instructions
